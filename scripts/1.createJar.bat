...
set workspace=C:\Users\bn0418\Desktop\MIW\maven2
::Las variables de entorno se pueden configurar directamente en Windows cuando se tienen los permisos necesarios
set JAVA_HOME=C:\Program Files\Java\jdk1.8.0_51
set M2_HOME=C:\Users\bn0418\Desktop\MIWArchivosDePrograma\apache-maven-3.3.9-bin\apache-maven-3.3.9
...
call mvn --version
call mvn clean package install -Denvironment.type=preproduction
echo .
